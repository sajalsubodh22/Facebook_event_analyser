...
ui <-fluidPage( 
  tags$head(
    tags$style('#home,#pie,#geo,#cloud,#predict{background-color:#406FFF;color:white}')
  ),
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      wellPanel(
        helpText(HTML("<font size = 6><b>Predict your event</b></font><br>Ever wondered how many people will turn up at your event? Find it out here..")),
